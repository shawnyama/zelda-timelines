...
| Sabrblade | Sabrblade a.k.a. Miles Tinker | The games themselves, Creating A Champion, and Master Works 2. No What-if branches, no reincarnating Ganondorfs (FSAdorf is OOTdorf, but TOTKdorf is an entirely separate man with the same name), FSA follows FS, five spinoffs included, True Founding, and some minor retcons to smooth out the rougher edges. | December 29, 2025 |
