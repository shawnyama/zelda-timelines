...
export enum Events {
  ...
  CityInTheSky = 'The Sky People build a City in the Sky. Relations are kept with Hyrule by a Messenger to the Heavens - TP',
  ...
  HWMM = 'The masked Skull Kid is briefly transported to the future before returning here to his native time - HW',
  ...
  SleepingPrincessZelda = 'A Magician casts a sleeping spell on the Princess. The regretful Prince entrusts the task of awakening his sister to a future Hero worthy of the full Triforce - TAOL',
  ...
  ChampionsGoBackInTime = 'The four new Champions are summoned to the altered past by Terrako. They help stop the Great Calamity there and return to their native time and dimension - AOC',
