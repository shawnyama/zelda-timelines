...
export enum Events {
  ...
  HyliaTriforceSecretStonesZonai = 'Hylia protects the Triforce and entrusts the Secret Stones to the Zonai Tribe, who prosper on the Surface - SS/MW2',
  ...
  DemiseWarAgainstHylia = 'The Demon Tribe emerges from the Earth. The Demon King Demise wars against Hylia to claim the Triforce for himself - SS',
  ...
  NewTribesFormed = 'New tribes are formed on the Surface. The land is named Hyrule in honor of Hylia. The Gerudo Tribe forms their own all-female nation, with only one male born every 100 years - MW2',

  StormwindArkOtherStructures = 'A Zonai falls out of the sky down to Rito Village. The Rito Tribe helps this Zonai return home to the sky. The Stormwind Ark is gifted to the Rito as thanks. Other structures are built to improve living conditions across the land - TOTK/MW2',
  ZonaiExtinctionMingle = 'The Zonai face extinction by their warrior Constructs and return to the Surface, hiding away the Forbidden Constructs. The Zonai mingle with the surface tribes, but their numbers continue to dwindle - AOI/MW2',
  RauruMarriesSonia = 'The Zonai Rauru marries the Hylian priestess Sonia. They begin a Pilgrimage of Purification across the land - TOTK MW2/AOI',
  ...
  CityInTheSky = 'The Sky People build a City in the Sky. Relations are kept with Hyrule by a Messenger to the Heavens. Over time, all contact with the Sky People is lost - TP',
  ...
  FierceWar = 'A fierce war ends with the King of Hyrule unifying the land - OOT',
  ...
  HyruleIsFlooded = 'Ganondorf emerges from the depths of the Earth and attacks Hyrule. The gods flood the land, sealing Hyrule beneath the flood - TWW',
  OriginalGanondorfDrowns = 'The original Ganondorf drowns in the flood, killed by the gods themselves. His successor remains sealed in the void - minor retcon',
  ...
  GanondorfEscapesTheVoid = 'The Ganondorf sealed in the void finally breaks free. He learns of what all happened before and uses a portal in his desert tower to reach the Great Sea - TWW',
  ...
  NewLandNewHyruleNewFounding = 'The pirate crew captained by Tetra reach a new land, the same one Malladus attacked long ago. A new Hyrule Kingdom is later founded in this land - ST',
  ...
  HWMM = 'The masked Skull Kid is briefly transported to the future before returning to his native time - HW',
  ...
  GanondorfInvadesHyrule = 'His past attempt to claim the Triforce having been averted, Ganondorf launches an invasion of Hyrule - TP',
  ...
  GanondorfExecutionBanishment = 'Ganondorf is defeated and set to be executed by six Sages. A divine prank lets him to survive and murder the Sage of Water. He is banished to the Twilight Realm - TP',
  NewZorasDomainRutoNabooruSages = 'The ancestral home of the Zora becomes a new Zoras Domain. Ruto of the Zora and Nabooru of the Gerudo both become Sages - TP/BOTW',
  ...
  ALTTPBackstory = 'Ganondorf leads a band of thieves into the Sacred Realm, opened by chance. He claims the full Triforce and becomes the Demon King Ganon - ALTTP',
  ...
  AgahnimConquersHyrule = 'The dark priest Agahnim appears. He deceives the King of Hyrule and plots to free Ganon from the Dark World - ALTTP',
  ...
  SahasrahlaSearchesForLink = 'With Link having been gone for six years, Sahasrahla leaves Hyrule to search for him and bring him home - AST',
  ...
  GreatKingTriforce = 'In an age of peace, a great King uses the full Triforce to maintain order in Hyrule. Upon his passing, his son inherits an incomplete Triforce. The Prince questions his sister, Princess Zelda, about the rest of the Triforce, but she says nothing - TAOL',
  SleepingPrincessZelda = 'A Magician casts a sleeping spell on the Princess. The mournful Prince entrusts the task of awakening his sister to a future Hero worthy of the full Triforce - TAOL',
  GanonInvadesHyrule = 'The Great Demon King Ganon invades Hyrule with an army and seizes the Triforce of Power - TLOZ',
  ZeldaSplitsTriforceOfWisdom = 'The Princess Zelda of this age splits the Triforce of Wisdom into eight pieces to protect them from Ganon - TLOZ',
  ...
  YigaClanFormed = 'The Yiga Clan is formed out of a divide within the Sheikah Tribe - BOTW/CAC',
  GreatCalamity = 'The Great Calamity devastates Hyrule - BOTW/CAC',

  TerrakoTravelsBackInTime = 'Terrako travels back in time',
  ChampionsGoBackInTime = 'The four new Champions are summoned to the altered past by Terrako. They help stop the Great Calamity there and return here to their native time and dimension - AOC',
  OriginalGanondorfFinallyBreaksSeal = 'After literal eons, the original Ganondorf is finally able to break his seal, due to Hyrule Castle suffering extensive damage in the Great Calamity - TOTK'
}
